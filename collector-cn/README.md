...
| 任务 | 周期 | VBS 参数 | topic |
|---|---|---|---|
| `collector_offer_10m` | 每 10 分钟 | `offer` | 7 快 topic |
...
## 节奏（v1.3）
- 10m 档 7-topic 快批（~35s），**不含** `jc_odds_history`（防僵尸堆积，2026-09-16 死机复盘）
- 4 个 daily 档 8-topic（含 `jc_odds_history`，单批 ~60-75s，QPS=1.0）
